...
public abstract class ProgressNewDialogSubscriber<T> extends ErrHandlerSubscriber<T> implements ProgressDialogHandler.OnProgressCancelListener {
    ...
    public ProgressNewDialogSubscriber(Context context, BaseView mView){
...
//    }
//
//    public ProgressNewDialogSubscriber(Context context, DBaseView  mView,boolean isStartShow, boolean isEndDismiss) {
//        super(context);
//        this.mView=mView;
//        this.isStartShow=isStartShow;
